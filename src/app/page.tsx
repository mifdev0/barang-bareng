...
export default function Home() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-50">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-12">
            ...
            <div className="col-span-1 lg:col-span-6 text-center">
              <span className="inline-flex items-center gap-1.5 rounded-full bg-blue-50 px-3.5 py-1.5 text-xs font-semibold text-blue-700 mb-6 border border-blue-100">
              ...
              {/* Quick statistics */}
              <div className="mt-8 flex justify-center items-center gap-6 text-xs text-slate-500 font-semibold">
                <span>⚡ Real-time Negosiasi</span>
                <span className="h-1.5 w-1.5 rounded-full bg-slate-300"></span>
                <span>🔒 Transfer Aman ke Rekening Bersama</span>
                <span className="h-1.5 w-1.5 rounded-full bg-slate-300"></span>
      ...
      <section id="katalog" className="container mx-auto px-4 sm:px-6 py-16">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-10 gap-4">
          <div>
            <h2 className="text-3xl font-black text-slate-900 tracking-tight">Katalog Pilihan Terpopuler</h2>
            <p className="text-slate-500 mt-1">Daftar barang rental kualitas prima dengan harga terjangkau</p>
          </div>
          
          <div className="flex items-center gap-2 text-sm text-slate-500 font-semibold bg-white px-3.5 py-2 rounded-lg border border-slate-200">
